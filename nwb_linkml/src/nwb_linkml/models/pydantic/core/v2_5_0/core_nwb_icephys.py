...
class IntracellularElectrodesTable(DynamicTable):
    ...
    electrode: Optional[List[IntracellularElectrode]] = Field(
        default_factory=list,
...
class IntracellularStimuliTable(DynamicTable):
    ...
    stimulus: IntracellularStimuliTableStimulus = Field(
        ...,
...
class IntracellularResponsesTable(DynamicTable):
    ...
    response: IntracellularResponsesTableResponse = Field(
        ...,
...
class SimultaneousRecordingsTable(DynamicTable):
    ...
    recordings_index: SimultaneousRecordingsTableRecordingsIndex = Field(
...
class SequentialRecordingsTable(DynamicTable):
    ...
    simultaneous_recordings_index: SequentialRecordingsTableSimultaneousRecordingsIndex = Field(
        ..., description="""Index dataset for the simultaneous_recordings column."""
    )
    stimulus_type: Optional[List[str]] = Field(
        default_factory=list,
...
class RepetitionsTable(DynamicTable):
    ...
    sequential_recordings_index: RepetitionsTableSequentialRecordingsIndex = Field(
...
class ExperimentalConditionsTable(DynamicTable):
    ...
    repetitions_index: ExperimentalConditionsTableRepetitionsIndex = Field(
