...
class DecompositionSeries(TimeSeries):
    ...
    source_channels: Optional[DecompositionSeriesSourceChannels] = Field(
        None,
...
class Units(DynamicTable):
    ...
    waveforms_index: Optional[UnitsWaveformsIndex] = Field(
        None,
        description="""Index into the waveforms dataset. One value for every spike event. See 'waveforms' for more detail.""",
    )
    waveforms_index_index: Optional[UnitsWaveformsIndexIndex] = Field(
        None,
