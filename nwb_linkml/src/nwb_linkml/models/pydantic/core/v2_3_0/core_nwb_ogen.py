...
from .core_nwb_base import TimeSeriesSync, TimeSeries, TimeSeriesStartingTime, NWBContainer
...
class OptogeneticSeries(TimeSeries):
    ...
    data: List[float] = Field(
        default_factory=list, description="""Applied power for optogenetic stimulus, in watts."""
    )
